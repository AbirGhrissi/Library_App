 ...
 */
final class Version20251205111828 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_favorite_books (user_id INT NOT NULL, book_id INT NOT NULL, INDEX IDX_9716DEEFA76ED395 (user_id), INDEX IDX_9716DEEF16A2B381 (book_id), PRIMARY KEY (user_id, book_id)) DEFAULT CHARACTER SET utf8mb4');
